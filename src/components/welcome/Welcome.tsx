...
import { WelcomeStyle, WelcomeTitle, TypingArea, WelcomeContent } from './styled';
...
export const WelcomeComponents = ({titleAnimation, titleAnimationData, normalTitle}: WelcomeTypes) => {
	...
	return (
		<WelcomeStyle>
			...
			<WelcomeContent>
				...
				<p>프론트 뿐만 아니라 백, 모바일 등 다양한 분야를 목표로 하고 있습니다.</p>
				<p>신규 서비스가 시장에 잘 자리잡을 수 있도록 리딩할 수 있는 개발자로 성장하고 싶습니다.</p>
			</WelcomeContent>
		</WelcomeStyle>
	)
}